...
- structured upgrade-card rails for uniqueness, printed values, range, keywords, talents, faction, and cost
- locally hosted STAW 2E symbol font supplied by the project owner
